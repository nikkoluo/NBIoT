...
* Version            :  V1.0
* Date               :  12/28/2016
* Description        :  Temp_Humi_SHT30 header file
*******************************************************************************/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __TEMP_HUMI_SHT30_H
#define __TEMP_HUMI_SHT30_H
...
extern  u8 SHT3x_Read_SN(u8 *ucSN);                                     // ¶ÁÈ¡SN
extern  u8 SHT3x_Soft_Reset(void);                                      // Èí¸´Î»
extern  u8 SHT3x_Get_Temp_Humi(float *fTemp, float *fHumi);             // »ñÈ¡ÎÂÊª¶È
