...
/* Private variables ---------------------------------------------------------*/
extern const u8 Temp_Unit[32];											// 摄氏度标号
...
extern  void OLED_CLS(void);										    // 清空数据
...
extern  void OLED_String_8x16(u8 x, u8 y, u8 *pData, u8 ucLen);			// 写8*16字符
extern  void OLED_String_16x16(u8 x, u8 y, u8 *pData, u8 ucLen);		// 16 * 16字符

extern  u8 OLED_Pos_Center(u8 ucLen);									// 计算居中对齐坐标
