...
#define DEVICE_NAME                          "MJ_HT_V1_DFU"                                          /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                    "ClearGrass"                                            /**< Manufacturer. Will be passed to Device Information Service. */
