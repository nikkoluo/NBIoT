...
// 排除boot和sd的可用空间 0x3c000 - 0x18000 - 保存信息及绑定页面(6)
...
#define DFU_APP_DATA_RESERVED           0x1800                                                          /**< Size of Application Data that must be preserved between application updates. This value must be a multiple of page size. Page size is 0x400 (1024d) bytes, thus this value must be 0x0000, 0x0400, 0x0800, 0x0C00, 0x1000, etc. */
